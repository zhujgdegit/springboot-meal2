...
public interface DiningCarRepository extends JpaRepository<DiningCar, Integer> {
	...
	@Query("SELECT u.nackname as nackName,u.telephone as telephone, fo.name as foodName, o.ordCode as ordCode, o.creatTime as creatTime, o.status AS status, o.comment as comments FROM OrderInfo o left JOIN user u on u.id = o.userId LEFT JOIN food fo on fo.id = o.foodId ")
